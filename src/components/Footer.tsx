        ...
        <div className="grid md:grid-cols-5 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400 dark:text-gray-500">
              ...
              <li><a href="/monthly-rent-subsidy" className="hover:text-white transition-colors">{t('footer.links.monthlyRentSubsidy')}</a></li>
              <li><a href="/bogeumjari-loan" className="hover:text-white transition-colors">{t('footer.links.bogeumjariLoan')}</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400 dark:text-gray-500">
              ...
              <li><a href="/qr-generator" className="hover:text-white transition-colors">{t('footer.links.qrGenerator')}</a></li>
              <li><a href="/barcode-generator" className="hover:text-white transition-colors">{t('footer.links.barcodeGenerator')}</a></li>
