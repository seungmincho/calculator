...
export const metadata: Metadata = {
  title: '택시 요금 계산기 - 지역별 심야할증·시외할증 자동 | 툴허브',
  description: '전국 17개 시·도 택시 요금 계산기. 거리·시간·탑승 시각을 입력하면 지역별 기본요금과 심야할증(시간대별 20~40%), 시외할증까지 자동 반영해 예상 택시비를 계산합니다. 일반·모범·대형 비교, 결과 이미지 저장.',
...
export default function TaxiFarePage() {
  ...
  const faqJsonLd = {
    ...
    mainEntity: [
      ...
      { '@type': 'Question', name: '택시 기본요금은 지역마다 다른가요?', acceptedAnswer: { '@type': 'Answer', text: '네. 2025년 기준 서울·경기·인천 일반택시 기본요금은 4,800원(1.6km), 대구·경북 4,500원(1.7km), 대전·광주·울산 4,300원, 그 외 지역은 대체로 4,000원(2.0km) 수준입니다. 거리요금 단위(예: 서울 131m당 100원)도 지역마다 차이가 있습니다.' } },
    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800 py-8">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <Suspense fallback={null}><I18nWrapper><TaxiFare />  <div className="mt-8">
    <RelatedTools />
  </div>
      ...
      <section className="max-w-4xl mx-auto px-4 pb-12">
        <div className="mt-12 border-t border-gray-200 dark:border-gray-700 pt-8">
          ...
          <ul className="list-disc list-inside space-y-2 text-gray-700 dark:text-gray-300 mb-6">
            <li><strong>기본요금:</strong> 서울·경기·인천 4,800원(1.6km), 대구·경북 4,500원, 대전·광주·울산 4,300원, 그 외 지역 약 4,000원.</li>
