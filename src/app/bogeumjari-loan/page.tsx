...
export default function BogeumjariLoanPage() {
  const jsonLd = {
    ...
    featureList: [
      '2026년 9월 최신 금리 반영 (기준 4.90~5.20%, 우대 시 3.90%~)',
  ...
  const faqJsonLd = {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: '보금자리론 대출 기간은 10년, 15년, 20년, 25년, 30년, 40년, 50년 중 선택할 수 있습니다. 기간이 길수록 금리가 소폭 높아집니다(10년 4.90% → 50년 5.20%). 40세 미만은 체증식 상환(초기 부담 낮은 방식)도 선택 가능합니다.',
        },
      },
      {
        '@type': 'Question',
        ...
        <div className="max-w-4xl mx-auto px-4 py-12 space-y-12">
          ...
          <section>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {[
                { label: '기준금리', value: '4.90~5.20%', sub: '우대 시 최저 3.90%', color: 'blue' },
              ...
              <table className="w-full text-sm border-collapse">
                ...
                <tbody>
                  {[
                    ...
                    { label: '금리 수준', didim: '2.15~3.0%', bogeum: '4.90~5.20% (우대 시 3.90%~)' },
