...
export const menuConfig: MenuConfig = {
  calculators: {
    ...
    items: [
      ...
      { href: '/national-pension', labelKey: 'footer.links.nationalPension', descriptionKey: 'toolsShowcase.tools.nationalPension.description', icon: '🏛️', addedDate: '2026-03-22', subcategory: 'subcategory.investSavings' },
  ...
  tools: {
    ...
    items: [
      ...
      { href: '/order-picker', labelKey: 'footer.links.orderPicker', descriptionKey: 'toolsShowcase.tools.orderPicker.description', icon: '🔀', addedDate: '2026-03-28', subcategory: 'subcategory.decision' },
      { href: '/menu-roulette', labelKey: 'footer.links.menuRoulette', descriptionKey: 'toolsShowcase.tools.menuRoulette.description', icon: '🎰', addedDate: '2026-03-28', subcategory: 'subcategory.decision' },
      { href: '/menu-picker', labelKey: 'footer.links.menuPicker', descriptionKey: 'toolsShowcase.tools.menuPicker.description', icon: '🍽️', subcategory: 'subcategory.decision' },
  ...
  health: {
    ...
    items: [
      ...
      { href: '/meal-diary', labelKey: 'footer.links.mealDiary', descriptionKey: 'toolsShowcase.tools.mealDiary.description', icon: '📓', addedDate: '2026-03-22' },
